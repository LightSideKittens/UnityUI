...
namespace TMPro
{
    public class TMP_TextParsingUtilities
    {
        ...
        {
            return !(c >= 0x300 && c <= 0x36F || c >= 0x1AB0 && c <= 0x1AFF || c >= 0x1DC0 && c <= 0x1DFF ||
                     c >= 0x20D0 && c <= 0x20FF || c >= 0xFE20 && c <= 0xFE2F || c == 0xE31 ||
                     c >= 0xE34 && c <= 0xE3A || c >= 0xE47 && c <= 0xE4E || c >= 0x591 && c <= 0x5BD || c == 0x5BF ||
                     c >= 0x5C1 && c <= 0x5C2 || c >= 0x5C4 && c <= 0x5C5 || c == 0x5C7 || c >= 0x610 && c <= 0x61A ||
                     c >= 0x64B && c <= 0x65F || c == 0x670 || c >= 0x6D6 && c <= 0x6DC || c >= 0x6DF && c <= 0x6E4 ||
                     c >= 0x6E7 && c <= 0x6E8 || c >= 0x6EA && c <= 0x6ED ||
        ...
        internal static bool IsHangul(uint c)
        {
            return c >= 0x1100 && c <= 0x11ff || c >= 0xA960 && c <= 0xA97F || c >= 0xD7B0 && c <= 0xD7FF ||
                   c >= 0x3130 && c <= 0x318F || c >= 0xFFA0 && c <= 0xFFDC || c >= 0xAC00 && c <= 0xD7AF;
        }

        internal static bool IsCJK(uint c)
        {
            return c >= 0x3100 && c <= 0x312F || c >= 0x31A0 && c <= 0x31BF || c >= 0x4E00 && c <= 0x9FFF ||
                   c >= 0x3400 && c <= 0x4DBF || c >= 0x20000 && c <= 0x2A6DF || c >= 0x2A700 && c <= 0x2B73F ||
                   c >= 0x2B740 && c <= 0x2B81F || c >= 0x2B820 && c <= 0x2CEAF || c >= 0x2CEB0 && c <= 0x2EBE0 ||
                   c >= 0x30000 && c <= 0x3134A || c >= 0xF900 && c <= 0xFAFF || c >= 0x2F800 && c <= 0x2FA1F ||
                   c >= 0x2F00 && c <= 0x2FDF || c >= 0x2E80 && c <= 0x2EFF || c >= 0x31C0 && c <= 0x31EF ||
                   c >= 0x2FF0 && c <= 0x2FFF || c >= 0x3040 && c <= 0x309F || c >= 0x1B100 && c <= 0x1B12F ||
                   c >= 0x1AFF0 && c <= 0x1AFFF || c >= 0x1B000 && c <= 0x1B0FF || c >= 0x1B130 && c <= 0x1B16F ||
                   c >= 0x3190 && c <= 0x319F || c >= 0x30A0 && c <= 0x30FF || c >= 0x31F0 && c <= 0x31FF ||
                   c >= 0xFF65 && c <= 0xFF9F;
        }
    }
}