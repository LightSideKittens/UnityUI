...
namespace TMPro
{
    public abstract partial class TMP_Text
    {
        ...
        public virtual string text
        {
            ...
            set
            {
                if (!m_IsTextBackingStringDirty && m_text != null && value != null && m_text.Length == value.Length &&
                    m_text == value)
                    return;
        ...
        public virtual Material fontSharedMaterial
        {
            ...
            set
            {
                if (m_sharedMaterial == value) return;
        ...
        [SerializeField] protected Material[] m_fontSharedMaterials;
        ...
        [SerializeField] protected Material[] m_fontMaterials;
        ...
        public bool enableVertexGradient
        {
            ...
            set
            {
                if (m_enableVertexGradient == value) return;
                _havePropertiesChanged = true;
        ...
        public bool tintAllSprites
        {
            ...
            set
            {
                if (m_tintAllSprites == value) return;
        ...
        [SerializeField] protected float m_fontSize = -99;
        ...
        [SerializeField] protected float m_fontSizeMin;
        ...
        [SerializeField] protected float m_fontSizeMax;
        ...
        protected TMP_TextProcessingStack<HorizontalAlignmentOptions> m_lineJustificationStack =
            new(new HorizontalAlignmentOptions[16]);
        ...
        public TextWrappingModes textWrappingMode
        {
            ...
            set
            {
                if (m_TextWrappingMode == value) return;
                _havePropertiesChanged = true;
        ...
        [SerializeField] protected List<OTL_FeatureTag> m_ActiveFontFeatures = new() { 0 };
        ...
        [SerializeField] protected bool m_isOrthographic;
        ...
        [SerializeField] protected float m_uvLineOffset;
        ...
        [SerializeField] protected bool m_VertexBufferAutoSizeReduction;
        ...
        [SerializeField] protected Vector4 m_margin = new(0, 0, 0, 0);
