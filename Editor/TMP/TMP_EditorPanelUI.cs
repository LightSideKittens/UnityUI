...
namespace TMPro.EditorUtilities
{
    ...
    {
        static readonly GUIContent k_RaycastTargetLabel =
            new("Raycast Target", "Whether the text blocks raycasts from the Graphic Raycaster.");

        static readonly GUIContent k_MaskableLabel =
            new("Maskable", "Determines if the text object will be affected by UI Mask.");
